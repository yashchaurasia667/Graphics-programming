...
int main()
{
...

  {
    ...
    Shader def("../shaders/blending.vs", "../shaders/blending.fs");
    ...
    VertexBuffer windowVbo(windowVertices, 5 * 6, GL_STATIC_DRAW);
    windowVao.addBuffer(windowVbo, layout);

    Texture cubeTex("../../assets/marble.jpg");
    Texture planeTex("../../assets/metal.png");
    Texture windowTex("../../assets/blending_transparent_window.png", GL_CLAMP_TO_EDGE);
    ...
    while (!glfwWindowShouldClose(window))
    {
      ...
      {
        float distance = glm::length(camera.get_pos() - windows[i]);
