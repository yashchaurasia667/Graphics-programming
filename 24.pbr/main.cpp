...
Camera camera(glm::vec3(0.0f, 0.0f, 3.0f), 45.0f, 0.1f, 2.5f);
...
int main()
{
  ...
  GLFWwindow *window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "LearnOpenGL", NULL, NULL); glfwMakeContextCurrent(window); if (window == NULL)
  {
